...
try {
    ...
    //Recipients
    $mail->setFrom("emailtestgrpa17@gmail.com", 'Mailer');
    $mail->addAddress('receveurmailtest@gmail.com', 'receveur');     //Add a recipient
    ...
    $mail->send();
     echo "<script>alert('Email envoyé'); window.location='index.html'</script>";
} catch (Exception $e) {
